...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,946 | 🐛 1,940 | 🌐 C++ | 📅 2026-05-07 can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 98 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-03-14 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
* [OKColor](https://github.com/KeeVeeGames/OKColor.gml) ⭐ 51 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-01-18 - An okay color manager for implementing OKLab/OKLCH colors.
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 32 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-15 - A constructor library for operating the primary functionalities of GameMaker.
...
* [GML-Classes](https://github.com/Nikko-the-cat/GML-Classes) ⭐ 16 | 🐛 0 | 🌐 Yacc | 📅 2024-05-08 - Another project that adds OOP functionality to GameMaker.
...
* [GMD3D11](https://github.com/blueburncz/GMD3D11) ⭐ 31 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-01-17 - A DLL for interfacing with Windows Direct3D.
...
* [Iota](https://github.com/JujuAdams/iota) ⭐ 47 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-14 - Lightweight timestep library.
...
* [GML Promise](https://github.com/tinkerer-red/GML-Promise) ⭐ 6 | 🐛 1 | 🌐 Game Maker Language | 📅 2025-11-27 - Another JS-style promise library.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 124 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-05-10 - Cross-platform programming language for modding support.
...
* [Dynamo](https://github.com/JujuAdams/Dynamo) ⭐ 33 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-14 - Dynamic data loader.
* [GMBenchmark](https://github.com/DragoniteSpam/GMBenchmark) ⭐ 33 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-02-10 - A tool to benchmark GML code.
...
* [Figgy](https://github.com/glebtsereteli/Figgy) ⭐ 24 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-10 - Centralized and persistent live configs for seamless game tuning and balancing.
* [Canvas](https://github.com/tabularelf/Canvas) ⭐ 20 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-11 - Another great solution for surface management.
...
* [GameMaker Scaffolding](https://github.com/babaganosch/GameMakerScaffolding) ⭐ 14 | 🐛 0 | 🌐 Yacc | 📅 2023-12-28 - Another cool all-encompassing template with a focus on building low-res, tile-based games.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 8 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-04 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [RenderStack](https://github.com/FoxyOfJungle/RenderStack) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-17 - Organize your game's rendering into a customizable order.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 366 | 🐛 21 | 🌐 JavaScript | 📅 2026-04-14 - Code editor to use in conjunction with GameMaker.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 13 | 🐛 53 | 🌐 Game Maker Language | 📅 2026-05-10 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
* [GMLVM](https://github.com/erkan612/GMLVM) ⭐ 3 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-28 - An easy to use complete GML interpreter to execute GML at runtime.
...
* [rt-shell](https://github.com/daikon-games/rt-shell) ⭐ 95 | 🐛 2 | 🌐 Game Maker Language | 📅 2023-07-11 - Easy to use in-game shell. Create your own commands, command meta data, command suggestions, history, etc.
* [Crispy](https://github.com/bfrymire/crispy) ⭐ 40 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-26 - Unit testing in GameMaker.
* [Snitch](https://github.com/JujuAdams/Snitch) ⭐ 37 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-05-05 - Crash and logging system.
* [Gobo](https://github.com/Pizzaandy/Gobo/) ⭐ 30 | 🐛 4 | 🌐 C# | 📅 2025-11-21 - An opinionated code formatter for GML.
...
* [Lookout](https://github.com/glebtsereteli/Lookout) ⭐ 19 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-01-28 - Helpful debug overlay views.
...
* [Gobo (EttyKitty fork)](https://github.com/EttyKitty/Gobo/) ⭐ 0 | 🐛 1 | 🌐 C# | 📅 2026-02-27 - A bit less opinionated code formatter for GML, with more options and functionality.
...
* [Good Vibes](https://github.com/mrdaneeyul/good-vibes) ⭐ 25 | 🐛 0 | 🌐 Yacc | 📅 2022-11-24 - Device vibration.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 407 | 🐛 27 | 🌐 Game Maker Language | 📅 2026-05-02 - Efficient multi-effects text renderer.
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 166 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-21 - Narrative scripting tool.
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 106 | 🐛 34 | 🌐 Svelte | 📅 2026-05-05 - An interactive dialogue editor for writers and programmers.
* [Textboxy](https://github.com/glitchroy/textboxy) ⭐ 65 | 🐛 9 | 🌐 Game Maker Language | 📅 2023-03-05 - Simple textboxes.
* [YUI](https://github.com/shdwcat/YUI) ⭐ 64 | 🐛 40 | 🌐 Game Maker Language | 📅 2026-05-03 - A UI system with live reloading, template system, data binding, and a drag and drop feature.
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 51 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-05-10 - Cross-platform UI framework.
* [NotificationSystem](https://github.com/babaganosch/NotificationSystem) ⭐ 44 | 🐛 0 | 🌐 Yacc | 📅 2023-12-28 - Notifications in GameMaker.
* [Emu UI](https://github.com/DragoniteSpam/Emu) ⭐ 40 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-02-18 - Common UI elements (text input, checkboxes, radio buttons, dialog boxes, etc).
* [LimeUI](https://github.com/Limekys/LimeUI) ⭐ 35 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-05-04 - Flexpanel system for modern, touch-friendly interfaces.
...
* [SimpleBook](https://github.com/Gizmo199/SimpleBook) ⭐ 8 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-05-07 - Simple book rendering framework.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 50 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-05-08 - Another localization solution focused on simplifying implementation.
* [polyglot](https://github.com/daikon-games/polyglot) ⭐ 31 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-02-23 - Localization library.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 155 | 🐛 30 | 🌐 TypeScript | 📅 2026-01-11 - Utilities for creating art asset pipelines.
...
* [Collage](https://github.com/tabularelf/Collage) ⭐ 29 | 🐛 10 | 🌐 Game Maker Language | 📅 2026-05-11 - Texture page builder and image manager. Mimics GameMaker's texture page packing while offering higher flexibility.
...
* [conveyorbelt](https://github.com/imissmyfriends/conveyorbelt) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2023-09-08 - Similar to ASESync. Export Aseprite files to GameMaker sprites.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 72 | 🐛 2 | 🌐 HTML | 📅 2026-04-24 - Official support for FMOD in GameMaker.
* [Vinyl](https://github.com/JujuAdams/Vinyl) ⭐ 57 | 🐛 6 | 🌐 Game Maker Language | 📅 2026-05-02 - Live updating audio system.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 112 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-05-07 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
* [LDtkParser](https://github.com/evolutionleo/LDtkParser) ⭐ 61 | 🐛 2 | 🌐 Game Maker Language | 📅 2025-08-14 - Advanced LDtk Importer.
...
* [Bulb](https://github.com/JujuAdams/Bulb) ⭐ 107 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-14 - 2D lighting and shadows.
...
* [Outline Shader](https://github.com/Grisgram/gml-outline-shader-drawer) ⭐ 25 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-10-16 - Outline shader.
...
* [Xpanda](https://github.com/GameMakerDiscord/Xpanda) ⭐ 15 | 🐛 1 | 🌐 GLSL | 📅 2026-05-05 - Include code from external files in your shaders.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 117 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-05-10 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Warp](https://github.com/evolutionleo/Warp) ⭐ 146 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-07 - A feature-rich framework for multiplayer games, written in GameMaker and Node.js.
* [Patchwire-GM](https://github.com/gm-core/patchwire-gm) ⭐ 35 | 🐛 0 | 🌐 Yacc | 📅 2020-09-13 - The network library from gm-core if you want to use this implementation without the entire gm-core suite.
...
* [HTTP GML](https://github.com/Sidorakh/http.gml) ⭐ 18 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-02-09 - Receive GET requests and upload files in GML.
...
* [GMHook](https://github.com/Kruger0/GMHook) ⭐ 11 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-19 - We really like Discord integration.
...
* [SnowState](https://github.com/sohomsahaun/SnowState) ⭐ 172 | 🐛 4 | 🌐 Game Maker Language | 📅 2025-06-29 - Robust finite state machine.
* [BehaviorTree](https://github.com/Gizmo199/BehaviorTree) ⭐ 12 | 🐛 0 | 🌐 Yacc | 📅 2023-12-18 - A simple behavior tree system.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 117 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-05-09 - Accurate framework to make classic Sonic games.
...
* [Tome](https://github.com/chesrowe/Tome/) ⭐ 12 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-30 - Automatically generate documentation sites from GameMaker projects.
* [Piano example](https://github.com/gmclan-org/piano_example) ⭐ 8 | 🐛 0 | 🌐 Game Maker Language | 📅 2023-02-17 - Example of playing instrument notes by changing pitch, using only one audio file.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,983 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,627 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 465 | 🐛 2 | 📅 2026-05-11.
