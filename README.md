...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,651 | 🐛 1,922 | 🌐 C++ | 📅 2026-04-21 can be compiled for free.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 12 | 🐛 62 | 🌐 Game Maker Language | 📅 2026-04-20 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 405 | 🐛 27 | 🌐 Game Maker Language | 📅 2026-03-30 - Efficient multi-effects text renderer.
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 166 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-21 - Narrative scripting tool.
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 98 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-21 - An interactive dialogue editor for writers and programmers.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 110 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-21 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,960 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,509 | 🐛 3 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 457 | 🐛 1 | 📅 2026-04-13.
