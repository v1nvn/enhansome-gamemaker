...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,907 | 🐛 1,935 | 🌐 C++ | 📅 2026-05-07 can be compiled for free.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 124 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-05-09 - Cross-platform programming language for modding support.
...
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 51 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-05-08 - Cross-platform UI framework.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 49 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-05-08 - Another localization solution focused on simplifying implementation.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 116 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-05-09 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,980 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,616 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 464 | 🐛 2 | 📅 2026-05-05.
