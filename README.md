...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,729 | 🐛 1,928 | 🌐 C++ | 📅 2026-04-21 can be compiled for free.
...
* [Agenda](https://github.com/benal20/Agenda.gml) ⭐ 4 | 🐛 2 | 🌐 Yacc | 📅 2026-04-27 - Schedule and delay the execution of callbacks.
...
* [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) ⭐ 33 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-04-15 - General purpose game editor.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 12 | 🐛 63 | 🌐 Game Maker Language | 📅 2026-04-28 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
* [GMLVM](https://github.com/erkan612/GMLVM) ⭐ 3 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-23 - An easy to use complete GML interpreter to execute GML at runtime.
...
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 104 | 🐛 30 | 🌐 Svelte | 📅 2026-04-28 - An interactive dialogue editor for writers and programmers.
...
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 5 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-15 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 111 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-24 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [SnowState](https://github.com/sohomsahaun/SnowState) ⭐ 169 | 🐛 4 | 🌐 Game Maker Language | 📅 2025-06-29 - Robust finite state machine.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,972 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,553 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 457 | 🐛 1 | 📅 2026-04-23.
