...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,301 | 🐛 1,910 | 🌐 C++ | 📅 2026-03-27 can be compiled for free.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 360 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-11 - Code editor to use in conjunction with GameMaker.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 11 | 🐛 58 | 🌐 Game Maker Language | 📅 2025-12-24 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
...
* [Gobo](https://github.com/Pizzaandy/Gobo/) ⭐ 29 | 🐛 4 | 🌐 C# | 📅 2025-11-21 - An opinionated code formatter for GML.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 401 | 🐛 27 | 🌐 Game Maker Language | 📅 2026-03-30 - Efficient multi-effects text renderer.
...
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 19 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-03-11 - Immediate mode GameMaker UI library, tons of UI components.
...
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 5 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-26 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [lexicon](https://github.com/tabularelf/lexicon) ⭐ 50 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-02-21 - Another localization solution focused on simplifying implementation.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 153 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-11 - Utilities for creating art asset pipelines.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 107 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-03-26 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 116 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-12 - Accurate framework to make classic Sonic games.
...
* [Tome](https://github.com/chesrowe/Tome/) ⭐ 11 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-30 - Automatically generate documentation sites from GameMaker projects.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,932 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,368 | 🐛 3 | 🌐 Markdown | 📅 2026-03-30.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 452 | 🐛 0 | 📅 2026-02-22.
