...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,509 | 🐛 1,920 | 🌐 C++ | 📅 2026-04-08 can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 95 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-03-14 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 32 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-07 - A constructor library for operating the primary functionalities of GameMaker.
...
* [Ngrams](https://github.com/tinkerer-red/Ngrams) ⭐ 2 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-10 - Lightweight n-gram library for fuzzy search, predictive text or token sequence modeling.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 122 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-20 - Cross-platform programming language for modding support.
...
* [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) ⭐ 33 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-02-24 - General purpose game editor.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 361 | 🐛 21 | 🌐 JavaScript | 📅 2026-03-11 - Code editor to use in conjunction with GameMaker.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 12 | 🐛 60 | 🌐 Game Maker Language | 📅 2025-12-24 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
...
* [Snitch](https://github.com/JujuAdams/Snitch) ⭐ 36 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-03-14 - Crash and logging system.
...
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 165 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-21 - Narrative scripting tool.
...
* [LimeUI](https://github.com/Limekys/LimeUI) ⭐ 34 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-03-29 - Flexpanel system for modern, touch-friendly interfaces.
...
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 19 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-03-31 - Immediate mode GameMaker UI library, tons of UI components.
...
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 5 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-31 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 49 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-06 - Another localization solution focused on simplifying implementation.
...
* [Collage](https://github.com/tabularelf/Collage) ⭐ 28 | 🐛 7 | 🌐 Game Maker Language | 📅 2026-03-21 - Texture page builder and image manager. Mimics GameMaker's texture page packing while offering higher flexibility.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 110 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-01 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [Bulb](https://github.com/JujuAdams/Bulb) ⭐ 104 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-03-14 - 2D lighting and shadows.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 114 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-03-24 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,949 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,452 | 🐛 3 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 455 | 🐛 0 | 📅 2026-04-09.
