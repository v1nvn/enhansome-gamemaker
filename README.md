...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,623 | 🐛 1,930 | 🌐 C++ | 📅 2026-04-17 can be compiled for free.
...
* [OKColor](https://github.com/KeeVeeGames/OKColor.gml) ⭐ 49 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-01-18 - An okay color manager for implementing OKLab/OKLCH colors.
...
* [Agenda](https://github.com/benal20/Agenda.gml) ⭐ 4 | 🐛 2 | 🌐 Yacc | 📅 2023-07-01 - Schedule and delay the execution of callbacks.
...
* [SSave](https://github.com/stoozey/SSave) ⭐ 42 | 🐛 11 | 🌐 Game Maker Language | 📅 2025-10-13 - Simple file saving system.
...
* [GMBenchmark](https://github.com/DragoniteSpam/GMBenchmark) ⭐ 32 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-02-10 - A tool to benchmark GML code.
...
* [Figgy](https://github.com/glebtsereteli/Figgy) ⭐ 23 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-10 - Centralized and persistent live configs for seamless game tuning and balancing.
* [Canvas](https://github.com/tabularelf/Canvas) ⭐ 19 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-11 - Another great solution for surface management.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-04 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 12 | 🐛 60 | 🌐 Game Maker Language | 📅 2026-04-20 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
...
* [Gobo (EttyKitty fork)](https://github.com/EttyKitty/Gobo/) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-02-27 - A bit less opinionated code formatter for GML, with more options and functionality.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 404 | 🐛 27 | 🌐 Game Maker Language | 📅 2026-03-30 - Efficient multi-effects text renderer.
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 166 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-21 - Narrative scripting tool.
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 97 | 🐛 9 | 🌐 JavaScript | 📅 2021-11-22 - An interactive dialogue editor for writers and programmers.
...
* [Collage](https://github.com/tabularelf/Collage) ⭐ 28 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-04-13 - Texture page builder and image manager. Mimics GameMaker's texture page packing while offering higher flexibility.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 72 | 🐛 2 | 🌐 HTML | 📅 2026-03-19 - Official support for FMOD in GameMaker.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 110 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-19 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [Bulb](https://github.com/JujuAdams/Bulb) ⭐ 105 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-03-14 - 2D lighting and shadows.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 115 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-04-15 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Warp](https://github.com/evolutionleo/Warp) ⭐ 144 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-22 - A feature-rich framework for multiplayer games, written in GameMaker and Node.js.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 117 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-12 - Accurate framework to make classic Sonic games.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,959 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,497 | 🐛 3 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 456 | 🐛 1 | 📅 2026-04-13.
