...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 37,073 | 🐛 1,957 | 🌐 C++ | 📅 2026-05-07 can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 99 | 🐛 6 | 🌐 Game Maker Language | 📅 2026-03-14 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 124 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-05-19 - Cross-platform programming language for modding support.
...
* [Gobo (EttyKitty fork)](https://github.com/EttyKitty/Gobo/) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-05-19 - A bit less opinionated code formatter for GML, with more options and functionality.
...
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 51 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-05-16 - Cross-platform UI framework.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 50 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-05-16 - Another localization solution focused on simplifying implementation.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 155 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-11 - Utilities for creating art asset pipelines.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,996 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,671 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 469 | 🐛 3 | 📅 2026-05-11.
