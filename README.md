...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,115 | 🐛 1,905 | 🌐 C++ | 📅 2026-03-16 can be compiled for free.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 32 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-17 - A constructor library for operating the primary functionalities of GameMaker.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 358 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-11 - Code editor to use in conjunction with GameMaker.
...
* [Crispy](https://github.com/bfrymire/crispy) ⭐ 41 | 🐛 7 | 🌐 Game Maker Language | 📅 2025-11-26 - Unit testing in GameMaker.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 399 | 🐛 26 | 🌐 Game Maker Language | 📅 2026-03-14 - Efficient multi-effects text renderer.
...
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 3 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-02 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 72 | 🐛 1 | 🌐 HTML | 📅 2026-03-17 - Official support for FMOD in GameMaker.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 114 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-03-13 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Warp](https://github.com/evolutionleo/Warp) ⭐ 143 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-22 - A feature-rich framework for multiplayer games, written in GameMaker and Node.js.
...
* [Tome](https://github.com/chesrowe/Tome/) ⭐ 11 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-03-16 - Automatically generate documentation sites from GameMaker projects.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,917 | 🐛 8 | 📅 2026-03-04 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,303 | 🐛 3 | 🌐 Markdown | 📅 2026-03-16.
