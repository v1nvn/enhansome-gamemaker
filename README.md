...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,847 | 🐛 1,934 | 🌐 C++ | 📅 2026-05-05 can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 97 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-03-14 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 124 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-20 - Cross-platform programming language for modding support.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 364 | 🐛 21 | 🌐 JavaScript | 📅 2026-04-14 - Code editor to use in conjunction with GameMaker.
...
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 104 | 🐛 34 | 🌐 Svelte | 📅 2026-05-05 - An interactive dialogue editor for writers and programmers.
...
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 51 | 🐛 16 | 🌐 Game Maker Language | 📅 2026-05-04 - Cross-platform UI framework.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 49 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-05-06 - Another localization solution focused on simplifying implementation.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 116 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-05-05 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,977 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,592 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 463 | 🐛 1 | 📅 2026-05-05.
