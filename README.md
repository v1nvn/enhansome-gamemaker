...
* For pixel art, [Aseprite](https://www.aseprite.org/) is a popular alternative to the native sprite editor. 💸
  * [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 36,788 | 🐛 1,932 | 🌐 C++ | 📅 2026-04-30 can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 96 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-03-14 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
* [OKColor](https://github.com/KeeVeeGames/OKColor.gml) ⭐ 50 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-01-18 - An okay color manager for implementing OKLab/OKLCH colors.
...
* [Agenda](https://github.com/benal20/Agenda.gml) ⭐ 4 | 🐛 2 | 🌐 Yacc | 📅 2026-04-30 - Schedule and delay the execution of callbacks.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 123 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-20 - Cross-platform programming language for modding support.
...
* [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) ⭐ 33 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-04-30 - General purpose game editor.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 363 | 🐛 21 | 🌐 JavaScript | 📅 2026-04-14 - Code editor to use in conjunction with GameMaker.
...
* [GMLC](https://github.com/tinkerer-red/GMLC) ⭐ 12 | 🐛 63 | 🌐 Game Maker Language | 📅 2026-04-29 - Runtime compiler and interpreter to load, compile, and execute GML code at runtime.
...
* [Snitch](https://github.com/JujuAdams/Snitch) ⭐ 37 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-03-14 - Crash and logging system.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 407 | 🐛 27 | 🌐 Game Maker Language | 📅 2026-04-30 - Efficient multi-effects text renderer.
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 166 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-21 - Narrative scripting tool.
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 104 | 🐛 34 | 🌐 Svelte | 📅 2026-05-01 - An interactive dialogue editor for writers and programmers.
...
* [LimeUI](https://github.com/Limekys/LimeUI) ⭐ 35 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-03-29 - Flexpanel system for modern, touch-friendly interfaces.
...
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 19 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-03-31 - Immediate mode GameMaker UI library, tons of UI components.
...
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-15 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 49 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-04-16 - Another localization solution focused on simplifying implementation.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 154 | 🐛 30 | 🌐 TypeScript | 📅 2026-01-11 - Utilities for creating art asset pipelines.
...
* [Collage](https://github.com/tabularelf/Collage) ⭐ 29 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-04-13 - Texture page builder and image manager. Mimics GameMaker's texture page packing while offering higher flexibility.
...
* [Vinyl](https://github.com/JujuAdams/Vinyl) ⭐ 57 | 🐛 6 | 🌐 Game Maker Language | 📅 2026-03-16 - Live updating audio system.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 112 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-04-24 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [Bulb](https://github.com/JujuAdams/Bulb) ⭐ 106 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-03-14 - 2D lighting and shadows.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 116 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-04-26 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Warp](https://github.com/evolutionleo/Warp) ⭐ 146 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-22 - A feature-rich framework for multiplayer games, written in GameMaker and Node.js.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 117 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-20 - Accurate framework to make classic Sonic games.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 2,976 | 🐛 8 | 📅 2026-03-21 or [MagicTools](https://github.com/ellisonleao/magictools#readme) ⭐ 16,572 | 🐛 4 | 🌐 Markdown | 📅 2026-04-09.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 460 | 🐛 1 | 📅 2026-04-23.
